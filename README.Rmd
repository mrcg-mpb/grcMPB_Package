...
This package, inspired by the malariagen/grcMalaria project, aims to streamline the analysis of SpotMalaria Genetic Report Cards (GRCs). 
The package offers tools to achieve several key objectives:

1. **Prevalence and Diversity**: Analyzing the distribution and genetic variation of malaria strains in different regions.
2. **Drug Resistance Profiling**: Identifying drug resistance markers.
3. **Geographical Mapping**: Visualizing the spread of various malaria strains geographically.
4. **Genetic Relationships**: Exploring genetic relatedness among samples using IBS matrices and associated plots.
